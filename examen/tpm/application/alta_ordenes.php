<?php
session_start();
require_once '../../app/OrdenesController.php';
...
// Verificar acción
if ($action === "buscar_por_fecha") {
  $fechaInicio = $_POST['fecha_inicio'];
  $fechaFin = $_POST['fecha_fin'];
  $ordenes = $ordenesController->obtenerOrdenesPorFecha($fechaInicio, $fechaFin);
} else {
  $ordenes = $ordenesController->obtenerTodasLasOrdenes();
}
...
<body data-pc-preset="preset-1" data-pc-sidebar-theme="light" data-pc-sidebar-caption="true" data-pc-direction="ltr"
  ...
  <div class="pc-container">
    ...
    <div class="pc-content">
      ...
      <form action="../../app/consultas_ordenes.php?action=buscar_por_fecha" method="POST" class="mb-4">
        <div class="mb-3">
      ...
      <table class="table">
        ...
        <tbody>
          <?php if (!empty($ordenes) && isset($ordenes['data'])): ?>
