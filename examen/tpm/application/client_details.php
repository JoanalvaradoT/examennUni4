    ...
    <div class="pc-content">
      ...
      <?php if ($cliente): ?>
        <div class="card" style="width: 18rem;">
          <div class="card-body">
            <h5 class="card-title">Nombre: <?php echo htmlspecialchars($cliente['name']); ?></h5>
            <h6 class="card-subtitle mb-2 text-muted">Email: <?php echo htmlspecialchars($cliente['email']); ?></h6>
            <p class="card-text">Número de Teléfono: <?php echo htmlspecialchars($cliente['phone_number']); ?></p>
            <a href="client_list.php" class="btn btn-primary">Volver a la lista</a>
          </div>
        </div>
      <?php else: ?>
