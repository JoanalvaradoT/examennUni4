...
<body data-pc-preset="preset-1" data-pc-sidebar-theme="light" data-pc-sidebar-caption="true" data-pc-direction="ltr"
            ...
            <div class="navbar-content">
                <ul class="pc-navbar">
                    ...
                    <li class="pc-item pc-hasmenu">
                        ...
                        <ul class="pc-submenu">
                            <li class="pc-item"><a class="pc-link" href="../application/client_alta.php">cliente</a>
                            </li>
                            <li class="pc-item"><a class="pc-link" href="../application/client_list.php">Lista De
                                    Clientes</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="pc-item pc-hasmenu">
                        <a href="#!" class="pc-link">
                            ...
                            <span class="pc-mtext">Producto</span><span class="pc-arrow"><i
                                    data-feather="chevron-right"></i></span></a>
                        <ul class="pc-submenu">
                            <li class="pc-item"><a class="pc-link" href="../application/ecom_product.php">Producto</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="pc-item pc-hasmenu">
                        <a href="#!" class="pc-link">
                            ...
                            <span class="pc-mtext">Usuarios</span><span class="pc-arrow"><i
                                    data-feather="chevron-right"></i></span></a>
                        <ul class="pc-submenu">
                            <li class="pc-item"><a class="pc-link" href="../application/alta_usuarios.php">Usuarios</a>
                            </li>
                            <li class="pc-item"><a class="pc-link" href="../application/lista_usuarios.php">Lista de
                                    usuarios</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="pc-item pc-hasmenu">
                        <a href="#!" class="pc-link">
                            ...
                            <span class="pc-mtext">Cupones</span><span class="pc-arrow"><i
                                    data-feather="chevron-right"></i></span></a>
                        <ul class="pc-submenu">
                            <li class="pc-item"><a class="pc-link" href="../application/alta_cupones.php">cupones</a>
                            </li>
                            <li class="pc-item"><a class="pc-link" href="../application/consulta_cupones.php">consulta
                                    de cupones</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="pc-item pc-hasmenu">
                        <a href="#!" class="pc-link">
                            ...
                            <span class="pc-mtext">Catalogos</span><span class="pc-arrow"><i
                                    data-feather="chevron-right"></i></span></a>
                        <ul class="pc-submenu">
                            <li class="pc-item"><a class="pc-link" href="../application/crud_categorias.php">CRUD de
                                    categorias</a></li>
                            <li class="pc-item"><a class="pc-link" href="../application/crud_marcas.php">CRUD de
                                    marcas</a></li>
                            <li class="pc-item"><a class="pc-link" href="../application/crud_tags.php">CRUD de tags</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="pc-item pc-hasmenu">
                        <a href="#!" class="pc-link">
                            ...
                            <span class="pc-mtext">Ordenes</span><span class="pc-arrow"><i
                                    data-feather="chevron-right"></i></span></a>
                        <ul class="pc-submenu">
                            <li class="pc-item"><a class="pc-link" href="../application/alta_ordenes.php">ordenes</a>
                            </li>
                        </ul>
                    </li>
    ...
    <div class="pc-container">
        ...
        <div class="pc-content">
            ...
            <form action="../../app/ProductoController.php?action=update&id=<?= htmlspecialchars($id) ?>" method="POST"
                enctype="multipart/form-data">
                <div class="mb-3">
                    <label for="name" class="form-label">Nombre del Producto:</label>
                    <input type="text" class="form-control" id="name" name="name"
                        value="<?= htmlspecialchars($productoData['name']) ?>" required>
                </div>
                <div class="mb-3">
                    <label for="slug" class="form-label">Slug:</label>
                    <input type="text" class="form-control" id="slug" name="slug"
                        value="<?= htmlspecialchars($productoData['slug']) ?>" required>
                </div>
                <div class="mb-3">
                    <label for="description" class="form-label">Descripción:</label>
                    <textarea class="form-control" id="description" name="description" rows="3"
                        required><?= htmlspecialchars($productoData['description']) ?></textarea>
                </div>
                <div class="mb-3">
                    <label for="features" class="form-label">Características:</label>
                    <textarea class="form-control" id="features" name="features" rows="3"
                        required><?= htmlspecialchars($productoData['features']) ?></textarea>
                </div>
                <div class="mb-3">
                    <label for="cover" class="form-label">Imagen del Producto:</label>
                    <input type="file" class="form-control" id="cover" name="cover">
                    <p>Imagen actual: <?= htmlspecialchars($productoData['cover']) ?></p>
                </div>
                <div class="mb-3">
                    ...
                    <select class="form-control" id="brand" name="brand" required>
                        ...
                        <?php foreach ($marcas['data'] as $marca): ?>
                            <option value="<?= htmlspecialchars($marca['id']) ?>" <?= $marca['id'] == $productoData['brand_id'] ? 'selected' : '' ?>>
