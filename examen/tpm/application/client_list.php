          ...
          <tbody>
            <?php foreach ($clientes as $cliente): ?>
              <tr>
                ...
                <td><?php echo htmlspecialchars($cliente['phone_number']); ?></td>
                <td>
                  <a href="client_details.php?id=<?php echo $cliente['id']; ?>"
                    class="btn btn-info btn-sm me-2 mb-1">Detalles</a>
                  <a href="client_modificar.php?id=<?php echo $cliente['id']; ?>"
                    class="btn btn-warning btn-sm me-2 mb-1">Editar</a>
                  <a href="../../app/ClienteController.php?action=delete&id=<?php echo $cliente['id']; ?>"
