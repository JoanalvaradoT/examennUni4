  ...
  <div class="pc-container">
    ...
    <div class="pc-content">
      <div class="card shadow-sm p-3 mb-3 bg-white rounded">
        ...
        <p><strong>Monto Mínimo:</strong> <?= htmlspecialchars($cupon['min_amount_required']) ?></p>
        <p><strong>Fecha de Inicio:</strong> <?= htmlspecialchars($cupon['start_date']) ?></p>
        <p><strong>Fecha de Fin:</strong> <?= htmlspecialchars($cupon['end_date']) ?></p>
        <p><strong>Usos Máximos:</strong> <?= htmlspecialchars($cupon['max_uses']) ?></p>
        <p><strong>Estado:</strong> <?= $cupon['status'] == 1 ? 'Activo' : 'Inactivo' ?></p>
      </div>
      <a href="consulta_cupones.php" class="btn btn-secondary">Volver</a>
    </div>
