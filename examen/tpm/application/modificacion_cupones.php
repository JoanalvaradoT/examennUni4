<?php
session_start();
require_once '../../app/CuponesController.php';
...
$cuponesController = new CuponesController();
$cupon = $cuponesController->obtenerDetalleCupon($_GET['id']);

if (!$cupon || !isset($cupon['data'])) {
...
<body data-pc-preset="preset-1" data-pc-sidebar-theme="light" data-pc-sidebar-caption="true" data-pc-direction="ltr"
  ...
  <div class="pc-container">
    ...
    <div class="pc-content">
      <h1>Editar Cupón</h1>
      <form action="consulta_cupones.php" method="POST">
        <input type="hidden" name="id" value="<?= htmlspecialchars($cupon['id']) ?>">
        <div class="mb-3">
          <label for="name" class="form-label">Nombre del Cupón:</label>
          <input type="text" class="form-control" id="name" name="name" value="<?= htmlspecialchars($cupon['name']) ?>"
            required>
        </div>
        <div class="mb-3">
          <label for="code" class="form-label">Código:</label>
          <input type="text" class="form-control" id="code" name="code" value="<?= htmlspecialchars($cupon['code']) ?>"
            required>
        </div>
        <div class="mb-3">
          <label for="percentage_discount" class="form-label">Descuento (%):</label>
          <input type="number" class="form-control" id="percentage_discount" name="percentage_discount"
            value="<?= htmlspecialchars($cupon['percentage_discount']) ?>" min="0" max="100" required>
        </div>
        <div class="mb-3">
          <label for="min_amount_required" class="form-label">Monto Mínimo Requerido:</label>
          <input type="number" class="form-control" id="min_amount_required" name="min_amount_required"
            value="<?= htmlspecialchars($cupon['min_amount_required']) ?>" required>
        </div>
        <div class="mb-3">
          <label for="start_date" class="form-label">Fecha de Inicio:</label>
          <input type="date" class="form-control" id="start_date" name="start_date"
            value="<?= htmlspecialchars($cupon['start_date']) ?>" required>
        </div>
        <div class="mb-3">
          <label for="end_date" class="form-label">Fecha de Fin:</label>
          <input type="date" class="form-control" id="end_date" name="end_date"
            value="<?= htmlspecialchars($cupon['end_date']) ?>" required>
        </div>
        <div class="mb-3">
          <label for="max_uses" class="form-label">Usos Máximos:</label>
          <input type="number" class="form-control" id="max_uses" name="max_uses"
            value="<?= htmlspecialchars($cupon['max_uses']) ?>" required>
        </div>
        <div class="mb-3">
