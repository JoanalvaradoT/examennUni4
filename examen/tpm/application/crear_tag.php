...
<body data-pc-preset="preset-1" data-pc-sidebar-theme="light" data-pc-sidebar-caption="true" data-pc-direction="ltr"
    ...
    <div class="pc-container">
        ...
        <div class="pc-content">
            ...
            <form action="/unidad4/examen/tpm/application/crud_tags.php?action=create" method="POST">
                <div class="mb-3">
                ...
                <button type="submit" class="btn btn-primary w-100">Guardar Etiqueta</button>
            </form>
        </div>
